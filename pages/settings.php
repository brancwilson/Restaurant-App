...
<body>
    ...
    <a href="close_shift.php" class="button" onclick="return confirm('Are you sure you want to close the shift? This will reset all tables and archive today\'s orders.')"></a>
